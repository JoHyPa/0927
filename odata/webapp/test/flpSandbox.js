		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Odata Sample",
									"targetURL": "#sapsyncodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapsyncodata-display": {
								"semanticObject": "sapsyncodata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.sync.odata",
									"url": sap.ui.require.toUrl("sap/sync/odata")
								}
							}
						}
					}
